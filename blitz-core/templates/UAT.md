...
- This section feeds directly into /blitz:plan-phase --gaps
...
5. status → "diagnosed"
6. Ready for /blitz:plan-phase --gaps with root causes
...
**Creation:** When /blitz:verify-work starts new session
...
- `/blitz:verify-work {phase}` picks up from first pending/blocked test
