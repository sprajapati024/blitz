...
│   └── gsd/           # Blitz-specific commands
├── blitz-core/     # Skill resources
...
**New Template:**
- Implementation: `blitz-core/templates/{name}.md`
- Documentation: Template is self-documenting (includes guidelines)

**New Workflow:**
- Implementation: `blitz-core/workflows/{name}.md`
- Usage: Reference from command with `@~/.claude/blitz-core/workflows/{name}.md`

**New Reference Document:**
- Implementation: `blitz-core/references/{name}.md`
