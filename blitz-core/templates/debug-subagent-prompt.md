...
Template for spawning blitz-debugger agent. The agent contains all debugging expertise - this template provides problem context only.
...
```python
Task(prompt=template, subagent_type="blitz-debugger", description="Debug UAT-001")
```
