...
NOTE: For comprehensive ecosystem research ("how do experts build this"), use /blitz:research-phase instead, which produces RESEARCH.md.
</purpose>
...
See ~/.claude/blitz-core/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
6. **Create DISCOVERY.md** using ~/.claude/blitz-core/templates/discovery.md structure:
...
1. **Scope the discovery** using ~/.claude/blitz-core/templates/discovery.md:
...
6. **Create comprehensive DISCOVERY.md:**
   ...
   - Full structure from ~/.claude/blitz-core/templates/discovery.md
...
Use ~/.claude/blitz-core/templates/discovery.md.
...
1. Discuss phase context (/blitz:discuss-phase [current-phase])
2. Create phase plan (/blitz:plan-phase [current-phase])
