...
```bash
node "$HOME/.claude/blitz-core/bin/blitz-tools.cjs" validate health $REPAIR_FLAG
```
...
- [E001] config.json: JSON parse error at line 5
  Fix: Run /blitz:health --repair to reset to defaults

- [E002] PROJECT.md not found
  Fix: Run /blitz:new-project to create
```
...
```
---
N issues can be auto-repaired. Run: /blitz:health --repair
```
</step>
...
```
Would you like to run /blitz:health --repair to fix N issues automatically?
```
...
```bash
node "$HOME/.claude/blitz-core/bin/blitz-tools.cjs" validate health
```
