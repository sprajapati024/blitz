<purpose>
Create executable phase prompts (PLAN.md files) for a roadmap phase with integrated research and verification. Default flow: Research (if needed) -> Plan -> Verify -> Done. Orchestrates blitz-phase-researcher, blitz-planner, and blitz-plan-checker agents with a revision loop (max 3 iterations).
</purpose>
...
Valid Blitz subagent types (use exact names — do not fall back to 'general-purpose'):
...
```bash
INIT=$(node "$HOME/.claude/blitz-core/bin/blitz-tools.cjs" init plan-phase "$PHASE")
...
**If `planning_exists` is false:** Error — run `/blitz:new-project` first.
...
```bash
PHASE_INFO=$(node "$HOME/.claude/blitz-core/bin/blitz-tools.cjs" roadmap get-phase "${PHASE}")
```
...
5. Commit:
```bash
node "$HOME/.claude/blitz-core/bin/blitz-tools.cjs" commit "docs(${padded_phase}): generate context from PRD" --files "${phase_dir}/${padded_phase}-CONTEXT.md"
```
...
If "Run discuss-phase first":
  **IMPORTANT:** Do NOT invoke discuss-phase as a nested Skill/Task call — AskUserQuestion
  ...
  ```
  Run this command first, then re-run /blitz:plan-phase {X}:

  /blitz:discuss-phase {X}
  ```
...
```
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 Blitz ► RESEARCHING PHASE {X}
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

◆ Spawning researcher...
```

### Spawn blitz-phase-researcher

```bash
PHASE_DESC=$(node "$HOME/.claude/blitz-core/bin/blitz-tools.cjs" roadmap get-phase "${PHASE}" | jq -r '.section')
```
...
<files_to_read>
- {context_path} (USER DECISIONS from /blitz:discuss-phase)
...
Task(
  ...
  subagent_type="blitz-phase-researcher",
...
**If found:**
1. Read template: `~/.claude/blitz-core/templates/VALIDATION.md`
...
```bash
UI_PHASE_CFG=$(node "$HOME/.claude/blitz-core/bin/blitz-tools.cjs" config-get workflow.ui_phase 2>/dev/null || echo "true")
UI_GATE_CFG=$(node "$HOME/.claude/blitz-core/bin/blitz-tools.cjs" config-get workflow.ui_safety_gate 2>/dev/null || echo "true")
```
...
```bash
PHASE_SECTION=$(node "$HOME/.claude/blitz-core/bin/blitz-tools.cjs" roadmap get-phase "${PHASE}" 2>/dev/null)
...
- options:
  - "Generate UI-SPEC first" → Display: "Run `/blitz:ui-phase {N}` then re-run `/blitz:plan-phase {N}`". Exit workflow.
...
1. Re-run: `/blitz:plan-phase {PHASE} --research`
2. Disable Nyquist with the exact command:
   `node "$HOME/.claude/blitz-core/bin/blitz-tools.cjs" config-set workflow.nyquist_validation false`
3. Continue anyway (plans fail Dimension 8)

Proceed to Step 8 only if user selects 2 or 3.

## 8. Spawn blitz-planner Agent

Display banner:
```
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 Blitz ► PLANNING PHASE {X}
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
<downstream_consumer>
Output consumed by /blitz:execute-phase. Plans need:
...
## 10. Spawn blitz-plan-checker Agent

Display banner:
```
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 Blitz ► VERIFYING PLANS
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
Task(
  ...
  subagent_type="blitz-plan-checker",
  model="{checker_model}",
...
```
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 Blitz ► AUTO-ADVANCING TO EXECUTE
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
```
Skill(skill="blitz:execute-phase", args="${PHASE} --auto --no-transition")
```
...
- **PHASE COMPLETE** → Display final summary:
  ```
  ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
   Blitz ► PHASE ${PHASE} COMPLETE ✓
  ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

  Auto-advance pipeline finished.

  Next: /blitz:discuss-phase ${NEXT_PHASE} --auto
  ```
...
- /blitz:plan-phase {X} --research — re-research first
...
5. **Retry:** Restart Claude Code and run `/blitz:plan-phase` again

If freezes persist, try `--skip-research` to reduce the agent chain from 3 to 2 agents:
```
/blitz:plan-phase N --skip-research
```
</windows_troubleshooting>
...
- [ ] blitz-phase-researcher spawned with CONTEXT.md
- [ ] Existing plans checked
- [ ] blitz-planner spawned with CONTEXT.md + RESEARCH.md
- [ ] Plans created (PLANNING COMPLETE or CHECKPOINT handled)
- [ ] blitz-plan-checker spawned with CONTEXT.md
