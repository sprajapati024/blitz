<purpose>
Generate a UI design contract (UI-SPEC.md) for frontend phases. Orchestrates blitz-ui-researcher and blitz-ui-checker with a revision loop. Inserts between discuss-phase and plan-phase in the lifecycle.
...
```bash
UI_RESEARCHER_MODEL=$(node "$HOME/.claude/blitz-core/bin/blitz-tools.cjs" resolve-model blitz-ui-researcher --raw)
UI_CHECKER_MODEL=$(node "$HOME/.claude/blitz-core/bin/blitz-tools.cjs" resolve-model blitz-ui-checker --raw)
```

Check config:

```bash
UI_ENABLED=$(node "$HOME/.claude/blitz-core/bin/blitz-tools.cjs" config-get workflow.ui_phase 2>/dev/null || echo "true")
```

**If `UI_ENABLED` is `false`:**
```
UI phase is disabled in config. Enable via /blitz:settings.
```
Exit workflow.
...
Recommended: run /blitz:discuss-phase {N} first to capture design preferences.
...
## 5. Spawn blitz-ui-researcher

Display:
```
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 Blitz ► UI DESIGN CONTRACT — PHASE {N}
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
```markdown
Read ~/.claude/agents/blitz-ui-researcher.md for instructions.
...
Template: ~/.claude/blitz-core/templates/UI-SPEC.md
</output>
...
Task(
  ...
  subagent_type="blitz-ui-researcher",
...
## 7. Spawn blitz-ui-checker

Display:
```
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 Blitz ► VERIFYING UI-SPEC
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
```markdown
Read ~/.claude/agents/blitz-ui-checker.md for instructions.
...
Task(
  ...
  subagent_type="blitz-ui-checker",
...
- Re-spawn blitz-ui-researcher with revision context:
...
2. Edit manually — open UI-SPEC.md in editor, re-run /blitz:ui-phase
...
```bash
node "$HOME/.claude/blitz-core/bin/blitz-tools.cjs" commit "docs(${padded_phase}): UI design contract" --files "${PHASE_DIR}/${PADDED_PHASE}-UI-SPEC.md"
```
...
- [ ] blitz-ui-researcher spawned with correct context and file paths
- [ ] UI-SPEC.md created in correct location
- [ ] blitz-ui-checker spawned with UI-SPEC.md
