...
class StateManager:
    ...
    def initialize_project(
        self, name: str, description: str, answers: Dict[str, str]
    ) -> Dict[str, Any]:
        """
    ...
    def update_phase(self, phase: ProjectPhase) -> Dict[str, Any]:
        ...
        return self.update_state({"project": {"phase": phase.value}})

    def update_agent_status(
        self, agent: str, status: str, task: str = None
    ) -> Dict[str, Any]:
        """Update agent status"""
        update = {
            "agents": {
    ...
    def get_status_summary(self) -> str:
        ...
        active_agents = [
            name for name, info in agents.items() if info.get("status") == "running"
        ]
...
if __name__ == "__main__":
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        # Complete research
        manager.update_state({"progress": {"research_complete": True}})
