...
Consumed by: /blitz:new-milestone (scans seeds and presents matches)
</objective>

<execution_context>
@~/.claude/blitz-core/workflows/plant-seed.md
</execution_context>

<process>
Execute the plant-seed workflow from @~/.claude/blitz-core/workflows/plant-seed.md end-to-end.
</process>
