...
<execution_context>
@~/.claude/blitz-core/workflows/session-report.md
</execution_context>

<process>
Execute the session-report workflow from @~/.claude/blitz-core/workflows/session-report.md end-to-end.
</process>
